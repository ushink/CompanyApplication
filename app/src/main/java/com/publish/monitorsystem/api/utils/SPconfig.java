...
public class SPconfig {
    ...
    public void SaveReaderParams(SysApplication.ReaderParams RP)
    {
    ...
    public SysApplication.ReaderParams ReadReaderParams()
    {
    	SysApplication.ReaderParams RP=new SysApplication().new ReaderParams();
